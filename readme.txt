...
1. Run app.py with templates subfolder containing index.html file in the same project folder.
   Document_similarity -->app.py, templates ->> index.html 
2. The link to run app locally on web browser is "0.0.0.0:5000" for linux/ubuntu. For windows, type "localhost:5000" on web browser to run the app.

alternative:

1. Run Document_Similarity.py on windows and check the link in console to run the app.
...
2. Run the downloaded image : docker run -it -p 5000:5000 maitraiyee/flaskapp:version1
